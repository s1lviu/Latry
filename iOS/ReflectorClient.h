...
public:
    ...
    // iOS audio session callbacks (public slots for signal/slot connections)
public slots:
    void notifyIOSAudioSessionInterrupted();
    void notifyIOSAudioSessionResumed(); 
    void notifyIOSBackgroundTaskExpired();
